...
class UDLDomainConfig(BaseDomainConfig):
    ...
    def get_valid_methodology_labels(self) -> list[str]:
        ...
        return [
            ...
            "ExecutiveBarrier",
            "CollaborativeBarrier",
            # Observable Outcomes & Behaviors
            "BehavioralManifestations",
            "ObservableLearningOutcomes",
            "ObservableBehavioralOutcomes",
            "ObservableLiteracyOutcomes",
            "ObservableLearningChallenges",
            "ObservableProblemSolvingOutcomes",
            "LearningChallenge",
            "LearningOutcomes",
            "BehavioralOutcome",
            "CognitiveOutcomes",
            ...
            "WorkflowOutcomes",
            "IndividualOutcomes",
            "UsabilityFailureOutcomes",
            # Cognitive & Executive Function
            "CognitiveProcesses",
            "AttentionalControlProcesses",
            "Metacognition",
            "Attention",
            "CriticalThinking",
            "PatternRecognition",
            ...
            "SelfRegulationProcesses",
            "AdaptiveThinkingProcesses",
            "ActionInitiationProcesses",
            "TemporalOrganizationProcesses",
            "SustainedDirectiveProcesses",
            "CreativeThinking",
            # Motivational & Affective
            "PerceptionsOfTaskValue",
            "AttributionalStyle",
            "Mindset",
            "Safety",
            "IntrinsicMotivation",
            ...
            "BeliefsAboutSelf",
            "OutcomeExpectancy",
            "RegulationOfBehavior",
            # Context & Environment
            "Context",
            "SensoryProcessing",
            "SensoryEnvironment",
            "SocioculturalPragmatic",
            "Colour",
            "Furniture",
            "Lighting",
            "Acoustics",
            ...
            # Literacy & Language
            "LiteracyProcessing",
            "ComprehensionProcessing",
            "LanguageKnowledge",
            "LanguageScaffolds",
            "VisualResources",
            # Mitigation & Support Strategies
            "ExternalizedExecutiveSupport",
            "InitiationCueing",
            "RelevanceEnhancementStrategy",
            "StrengthenedRecall",
            "ConcreteBridgingStrategy",
            "ConfidenceBuilding",
            "EmpowermentStrategy",
            "AccessibilityStrategy",
            "UniversalDesignForDigitalAccess",
            "CognitiveFlexibilityTraining",
            "ScaffoldedSkillDevelopment",
            "AccommodationForProcessingSpeed",
            "MnemonicsTechniques",
            "AttentionStaminaTraining",
            # Sensory & Environmental
            "SensoryOverload",
            "SensoryAccommodation",
            "InclusiveSensoryDesign",
            "SensoryRegulation",
            "SensoryBufferingStrategy",
            "ControlledInputStrategy",
            "PhysicalWellBeing",
            "PhysiologicalDistraction",
            # Digital
            "DigitalLearning",
            "Skills",
            "InclusiveLearning",
            ...
            "KnowledgeApplicationProcess",
            "ActiveCognitiveProcess",
            "EvaluateProcess",
            "OutcomeProcess",
            # Fallback
            "Concept",
    ...
    def get_special_needs_mapping(self) -> dict:
        ...
        return {
            "Adhd": {
                ...
                "support_needs": [
                    "externalized_executive_support",
                    "initiation_cueing",
                    "focus_tasks",
                    "movement_breaks",
                ],
            ...
            "Dyslexia": {
                ...
                "support_needs": [
                    ...
                    "alternative_text_formats",
                    "metacognitive_support",
                    "self_efficacy_building",
                ],
                "environmental_factors": [
                    "accessible_fonts",
                    "reduced_reading_pressure",
            ...
            "ForeignStudents": {
                ...
                "support_needs": [
                    "dual_language_materials",
                    "visual_supports",
                    "collaborative_glossaries",
                    "cultural_responsiveness",
                ],
                "environmental_factors": [
                    "culturally_responsive_environment",
                    "peer_language_models",
                    "subtitle_support",
                ],
            },
        }
