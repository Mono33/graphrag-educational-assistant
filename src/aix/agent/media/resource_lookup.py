...
class ResourceLookup:
    ...
    def _load_resources(self) -> None:
        ...
        try:
            with open(self.resources_path, encoding="utf-8") as f:
                data = json.load(f)
    ...
    def find_resources_for_topic(self, topic: str, max_results: int = 5) -> ResourceCollection:
        """
    ...
    def find_resources_for_concepts(
        self, concepts: list[str], max_per_concept: int = 2
    ) -> ResourceCollection:
        """
    ...
    def get_recommended_for(self, purpose: str, max_results: int = 5) -> list[ExpertResource]:
        """
        ...
        matching = [
            r for r in self.resources if purpose.lower() in [p.lower() for p in r.recommended_for]
        ]
    ...
    def to_streamlit_display(self, resources: list[ExpertResource]) -> list[dict[str, Any]]:
        """
