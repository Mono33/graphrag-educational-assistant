...
with open('neuro_audit_report.json', encoding='utf-8') as f:
    audit = json.load(f)
...
print('\n📊 Summary by Priority:')
print('   Priority 1 (Cross-Domain Bridges): 50')
print('   Priority 2 (Mechanism → Outcome): 75')
print('   Priority 3 (Bidirectional): 25')
print('   TOTAL: 150')
print('\n🎯 Expected Impact:')
print('   Current avg connectivity: 2.18')
print('   After adding 150 relationships: ~2.78')
print('   Target connectivity: 3.5+')
print('   Additional relationships needed: ~200 more')
