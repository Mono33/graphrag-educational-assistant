...
from aix.retrieval.query_metrics import MetricsCalculator
...
def format_pipeline_stages(result: dict) -> str:
    ...
    stages.append("**Status:** Complete ✓")
    stages.append("**Language:** Italian 🇮🇹")
                ...
                with st.expander("🎨 Genera Diagramma AI", expanded=False):
                        ...
                        with st.spinner(spinner_msg):
                            try:
                                if selected_generator == "mermaid":
                                    ...
                                    from aix.agent.media.image_generator import (
                                        DiagramType,
                                        ImageGenerator,
                                    )
                    ...
                    if st.session_state.get('generated_diagram'):
                        ...
                        if gen_diag['type'] == 'mermaid':
                            ...
                            st.caption("💰 Costo: GRATUITO | 📊 Formato: SVG")
